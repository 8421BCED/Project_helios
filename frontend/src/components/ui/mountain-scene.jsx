 ...
 * - Optimized with lower polygon segments and setPixelRatio limit for performance.
 */
export function GenerativeMountainScene() {
  ...
  useEffect(() => {
    ...
    // GEOMETRY - Reduced resolution from 128 to 64 for optimal performance
    ...
    const material = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
            ...
            // Layer 2: Detail
            displacement += snoise(vec3(position.x * noiseFreq * 2.0, position.y * noiseFreq * 2.0 - time * 0.15, 0.0)) * (noiseAmp * 0.5);
      ...
      fragmentShader: `
        ...
        void main() {
            ...
            vec3 finalColor = color * diffuse + vec3(1.0) * fresnel * 0.12;
